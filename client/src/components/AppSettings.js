        ...
        <Modal open = {open}>
            <Box sx = {appSet}>
                <Grid container sx = {{paddingBottom: "10px"}} >
                    <Grid item xs = {8}>
                        <Typography variant = "h4" sx = {{paddingLeft: "5px"}} >App Settings </Typography> 
                    </Grid>
                    <Grid item xs = {4}>
                ...
                <Box sx = {{display: "grid", gridTemplateRows: "repeat(2, 1fr)", gridTemplateColumns: "repeat(12, 1fr)", rowGap: 2, p: "20px"}}>
                    ...
                    <Box sx = {rightItem} gridColumn = "span 4">
                        <TextField id = "appName" onChange = {handleChange} variant = "outlined" sx = {{margin: "5px"}} size = "small"></TextField>
                    </Box>
                    <Box sx = {leftItem} gridColumn = "span 8">
                        <Typography variant = "body" fontWeight = "bold" sx = {{fontSize: "24px", paddingLeft: "5px"}} >Role Membership Sheet: </Typography>
                    </Box>
                    <Box sx = {rightItem} gridColumn = "span 4">
                        <TextField id = "roleMem" onChange = {handleChange} variant = "outlined" sx = {{margin: "5px"}} size = "small"></TextField>
                    </Box>
                </Box>
                <Box sx = {{display: "block", width: "40%", marginLeft: "auto", marginRight: "auto"}}>
                    <Button onClick = {createApp} fullWidth sx = {{marginLeft: "5px", marginRight: "5px"}} variant = "contained" >Create</Button>
                </Box>
            </Box>
        </Modal>
  )
